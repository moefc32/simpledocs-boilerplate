...
<div class="flex items-center text-sm relative">
    ...
    <input
        ...
        class="ps-10 {isSearchInputActive
            ? 'me-0 pe-4'
            : '-me-18 pe-22'} w-full -ms-11 md:w-70 h-10 border-1 border-gray-600 rounded-lg"
        placeholder="Search..."
    ...
    {#if searchResult.length && isSearchInputActive}
        <div
            class="search-dropdown flex flex-col gap-1 p-2 bg-slate-800 w-full md:w-70 border-1 border-gray-600 rounded-lg shadow-xl absolute z-100 top-12 md:top-15 right-0"
        >
